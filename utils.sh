...
function execute_notebook() {
    ...
    META_DATA="input_notebook=${INPUT_NOTEBOOK_GCS_PATH},output_notebook=${GCS_LOCATION}${PARAM_METADATA:-},startup-script-url=https://raw.githubusercontent.com/vivianmarcello-cpfl/nb_executor/main/notebook_executor.sh"
