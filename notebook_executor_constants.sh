...
readonly INPUT_NOTEBOOK_GCS_FILE="gs://cpfl_template/notebooks/teste2.ipynb"
readonly OUTPUT_NOTEBOOK_GCS_FOLDER="gs://cpfl_template/executions"
...
echo ""
readonly TEMPORARY_NOTEBOOK_PATH="gs://cpfl_template/executions/teste_00.ipynb"
